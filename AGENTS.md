...
| Monostable timing C | 50 V monolithic-ceramic 1 µF (across 1Cext ↔ 1Rext/Cext) | Reported on hand; nominal period ≈0.45·R·C ≈99 ms only for a matching vendor coefficient; bench verification of the assembled period is mandatory |
